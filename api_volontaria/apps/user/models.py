...
#     """
#     A custom field for autogenerated tokens
#     """
    
#     description = _(_("Token (of exactly %(max_length)s characters)"))
...
class APIToken(models.Model):
    ...
    # (which is why DRF, where the token is the primary key, needs an APIProxy class)
